...
DUMMY_CUSTOMER_ID = 'cus_G3RryQUasJG0Jw' # If you're making live requests, this should be a real customer ID
TEST_CUSTOMER_EMAIL = 'customer@example.com' # This email should correspond to the email on file for the customer ID above
